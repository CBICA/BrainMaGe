...
#nfbs_dataset_csv = 'nfbs-dataset-2samples.csv'
...
import csv
with open('pt_stats.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerows(pt_stats)
...
import csv
with open('ov_fp32_stats.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerows(ov_stats)
...
import csv
with open('ov_int8_stats.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerows(ov_int8_stats)
