...
nfbs_dataset_csv = 'nfbs-dataset-preprocessed.csv'
nfbs_dataset_csv = 'nfbs-dataset-test-preprocessed.csv'
...
def bench_pytorch_fp32():
    ...
    print (f"PyTorch Dice Mean: {pt_stats_df[:][2].mean():.5f}")
...
def bench_ov_fp32():
    ...
    print (f"OpenVINO FP32 Dice Mean: {ov_stats_df[:][2].mean():.5f}")
...
def bench_ov_int8():
    ...
    print (f"OpenVINO INT8 Dice Mean: {ov_int8_stats_df[:][2].mean():.5f}")
...
print(f"Mean Dice Scores for {pt_stats_df.shape[0]} images")
print (f"PyTorch Dice Mean: {pt_stats_df[:][2].mean():.5f}")
print (f"OpenVINO FP32 Dice Mean: {ov_stats_df[:][2].mean():.5f}")
print (f"OpenVINO INT8 Dice Mean: {ov_int8_stats_df[:][2].mean():.5f}")
