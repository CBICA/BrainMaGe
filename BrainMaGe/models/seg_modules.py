...
class UpsamplingModule(nn.Module):
    def __init__(
        ...
        self.interpolate = Interpolate(
            scale_factor=self.scale_factor, mode="trilinear", align_corners=True
        )
        self.conv0 = nn.Conv3d(
            input_channels,
            output_channels,
...
class FCNUpsamplingModule(nn.Module):
    def __init__(
        ...
        self.scale_factor = scale_factor
        self.interpolate = Interpolate(
            scale_factor=2 ** (self.scale_factor - 1),
            mode="trilinear",
            align_corners=True,
        )
        self.conv0 = nn.Conv3d(
